...
- Pattern:
    ...
    ```
#### Caching
- We can use caching for famous short url , with LFU and expiry as well. 
- let say there is short url generated by influencer and sharing on the post, then read of that short will be high. 
- we can have caching for alias as well. -> experimental. 
- or we can also use bloom filter
